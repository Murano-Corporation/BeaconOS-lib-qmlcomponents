...
QMAKE_CFLAGS -= --sysroot=/home/murano/delta/sysroot
QMAKE_CXXFLAGS -= --sysroot=/home/murano/delta/sysroot
QMAKE_LFLAGS -= --sysroot=/home/murano/delta/sysroot

QMAKE_CFLAGS += --sysroot=$$(HOME)/delta/sysroot
QMAKE_CXXFLAGS += --sysroot=$$(HOME)/delta/sysroot
QMAKE_LFLAGS += --sysroot=$$(HOME)/delta/sysroot
