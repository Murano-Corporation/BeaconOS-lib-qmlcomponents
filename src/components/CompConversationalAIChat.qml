...
Popup{
    ...
    property string popupName: "Popup - Chat AI"

    property alias cX: compConvAiChatRoot.x
    property alias cY: compConvAiChatRoot.y
    property alias cWidth: compConvAiChatRoot.width
    property alias cHeight: compConvAiChatRoot.height
    ...
    signal signal_GainedFocus(string id, bool focused)
