...
Item{
    id: compHealthDashboardContentGraphViewOmega
...
//    }
    ...
    Timer{
        ...
        interval: compHealthDashboardContentGraphViewOmega.devTimerInterval
    ...
    ChartView{
        ...
        DateTimeAxis {
            ...
            min: compHealthDashboardContentGraphViewOmega.dateMin
            max: compHealthDashboardContentGraphViewOmega.dateMax

            labelsFont:  Qt.font({family: 'Lato', weight: Font.Medium, pixelSize: 30})
            labelsColor: "White"
            labelsVisible: false
        }
        ...
        ValueAxis {
            ...
            titleText: compHealthDashboardContentGraphViewOmega.valueUnits
            color: "White"
            titleBrush: color

            min: compHealthDashboardContentGraphViewOmega.yValueMin
            max: compHealthDashboardContentGraphViewOmega.yValueMax
