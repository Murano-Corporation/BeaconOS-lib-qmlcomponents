...
//            property var listOfColumnWidths: [600, 160, 150]
//            property var listOfColumnWidthRatios: [0.45, 0.15, 0.10]
//            property var listOfColumnWidthsCurrent: [600,150,200]
            ...
            columnWidthProvider: col => {
                                     ...
                                     var iRow = col + 0;
                                     //console.log("Updating column width for col: " + iRow)
                                     ...
                                     var ret = tableView.model.headerData(iRow, Qt.Horizontal, Constants.DataRole_HeaderData_ColumnWidth);
            ...
            Row{
                ...
                Repeater {
                    ...
                    Rectangle{
                        ...
                        width: tableView.columnWidthProvider(col)
                        height: 100
...
//            }
    ...
    Loader{
        ...
        visible: compHealthDashboardContentParams.view === "Grid" && !compHealthDashboardContentParams.showGalleryInstance
...
//        }
    ...
    Loader{
        ...
        sourceComponent: CompHealthDashboardContentGraphViewOmega {
           ...
           MouseArea {
            ...
            onClicked: {
                console.log("height: " + compHealthDashboardContentGraphView.height);
                console.log("width: " + compHealthDashboardContentGraphView.width);
            }
           }
        }
