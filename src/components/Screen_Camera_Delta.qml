...
Screen__BASE {
    ...
    Rectangle {
        ...
        anchors{
            top: parent.top
            topMargin: isOverlayMode ? 100 : 39

            left: btnCaptureLeft.horizontalCenter

            right: btnCaptureRight.horizontalCenter
            rightMargin: 0
    ...
    Item{
        ...
        anchors{
            left: btnCaptureLeft.right
            leftMargin: 75

            right: btnCaptureRight.left
            rightMargin: 75
...
/*##^##
Designer {
    D{i:0;autoSize:true;formeditorZoom:0.33;height:1080;width:1920}
}
##^##*/
