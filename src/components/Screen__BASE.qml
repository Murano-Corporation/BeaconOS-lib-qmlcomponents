...
Comp__BASE {
    ...
    function setOverlayDefaults() {
        ...
        var openOrigin = Qt.point(
                    ((root.contentItem.width * 0.5) - openSize.width),
                    ((root.contentItem.height * 0.5) - openSize.height))

        SingletonOverlayManager.setPerScreenPopupOpenRect("Chat AI",
                                                          openOrigin, openSize)
        ...
        SingletonOverlayManager.setPerScreenPopupOpenRect("WiFi Viewer",
                                                          openOrigin, openSize)
    }
}
